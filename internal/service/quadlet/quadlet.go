...
func mergeUnitOptions(existing, new UnitOptions) UnitOptions {
	merged := existing
	if new.Description != "" {
...
func mergeServiceOptions(existing, new ServiceOptions) ServiceOptions {
	merged := existing
	if new.Restart != "" {
...
func mergeContainerOptions(existing, new ContainerOptions) ContainerOptions {
	merged := existing
	if new.Image != "" {
...
func mergeInstallOptions(existing, new InstallOptions) InstallOptions {
	merged := existing
